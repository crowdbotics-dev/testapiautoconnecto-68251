...
## Project Structure
    ...
    ├── testapiautoconnecto_68251  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_68251`
...
2. Clone this repo and `cd testapiautoconnecto_68251`
